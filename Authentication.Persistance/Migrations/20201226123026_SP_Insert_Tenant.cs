    ...
    public partial class SP_Insert_Tenant : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            BEGIN
                ...
                VALUES (@TenantId, @TenantEmail, @TenantEmailVerified, @TenantPasswordhash, @TenantFirstname, @TenantMiddlename, @TenantLastname, @Created, @LastModified);
                ...
                VALUES (@TenantId, @JwtConfigurationNbf, @JwtConfigurationExp, @Created, @LastModified)
            END";
