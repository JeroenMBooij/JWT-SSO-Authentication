        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dashboards_ApplicationUsers_TenantId1",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExpireHours = table.Column<long>(type: "bigint", nullable: false),
                    TenantId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JwtConfigurations_ApplicationUsers_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dashboards_TenantId1",
                table: "Dashboards",
                column: "TenantId1");

            migrationBuilder.CreateIndex(
                name: "IX_JwtConfigurations_TenantId1",
