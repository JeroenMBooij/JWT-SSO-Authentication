...
namespace Authentication.Persistance.Migrations
{
    ...
    [Migration("20201217174030_SP_Insert_Tenant_Language")]
    partial class SP_Insert_Tenant_Language
    {
            ...
            modelBuilder.Entity("AuthenticationServer.Domain.Entities.UserSchemaEntity", b =>
                {
                    ...
                    b.Property<string>("DataModelSchema")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TrackModelSchema")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
