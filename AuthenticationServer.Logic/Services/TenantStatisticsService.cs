...
{
    public class TenantStatisticsService : ITenantStatisticsService
    {
        private readonly ITenantAccountRepository _tenantAccountRepo;
        private readonly IJwtManager _jwtManager;
        private readonly IMapper _mapper;

        public TenantStatisticsService(ITenantAccountRepository tenantAccountRepo, IJwtManager jwtManager, IMapper mapper)
        {
